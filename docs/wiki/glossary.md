...
| SDR (UDP audio bridge) | Listens on UDP for `s16le`/`f32le` audio from an external SDR. Operator-visible exposure of this is not confirmed; treat as power-user / config-file path. | [`../../graywolf-modem/src/sdr/`](../../graywolf-modem/src/sdr/), [`../handbook/audio.html`](../handbook/audio.html) |
